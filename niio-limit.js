...
function onBot({ models }) {
    ...
    try {
        login({ appState: appstate }, (err, api) => {
            ...
            logger.loader(` NAME BOT: ${(!global.config.BOTNAME) ? "This bot was made by 𝐌𝐢𝐧𝐚𝐭𝐨" : global.config.BOTNAME}`);
            ...
            console.log(chalk.yellow(figlet.textSync('𝐌𝐢𝐧𝐚𝐭𝐨', { horizontalLayout: 'full' })));
